...
void _toDoSerialize(
  ...
  writer.writeDateTime(offsets[2], object.deadlineDate);
...
ToDo _toDoDeserialize(
  ...
  object.deadlineDate = reader.readDateTime(offsets[2]);
...
extension ToDoQueryFilter on QueryBuilder<ToDo, ToDo, QFilterCondition> {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> deadlineDateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> deadlineDateGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> deadlineDateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> deadlineDateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ToDoQuerySortBy on QueryBuilder<ToDo, ToDo, QSortBy> {
  ...
  QueryBuilder<ToDo, ToDo, QAfterSortBy> sortByDeadlineDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadlineDate', Sort.asc);
    });
  }

  QueryBuilder<ToDo, ToDo, QAfterSortBy> sortByDeadlineDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ToDoQuerySortThenBy on QueryBuilder<ToDo, ToDo, QSortThenBy> {
  ...
  QueryBuilder<ToDo, ToDo, QAfterSortBy> thenByDeadlineDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadlineDate', Sort.asc);
    });
  }

  QueryBuilder<ToDo, ToDo, QAfterSortBy> thenByDeadlineDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadlineDate', Sort.desc);
    });
  }
...
extension ToDoQueryWhereDistinct on QueryBuilder<ToDo, ToDo, QDistinct> {
  ...
  QueryBuilder<ToDo, ToDo, QDistinct> distinctByDeadlineDate() {
    return QueryBuilder.apply(this, (query) {
...
extension ToDoQueryProperty on QueryBuilder<ToDo, ToDo, QQueryProperty> {
  ...
  QueryBuilder<ToDo, DateTime, QQueryOperations> deadlineDateProperty() {
    return QueryBuilder.apply(this, (query) {
